...
const TimelineStickyComp = () => {
  return (
    <section className="bg-primary timeline-section">
      <h1 className="text-4xl text-white text-center mb-8">Timeline Section</h1>
          ...
          <div className="right-scroll-column">
            <div className="timeline-item">
              ...
              <p className="text-white mb-6">
                ...
                battlecruisers, including her eight 13.5-inch (343 mm) guns. She
                was completed in 1913 and participated in the Battle of
            ...
            <div className="timeline-item">
              ...
              <p className="text-white mb-6">
                ...
                and her magazines exploded shortly afterwards, sinking her with
                the loss of 1,266 of her 1,286 crew members.
              </p>
            </div>
            ...
            <div className="timeline-item">
              ...
              <p className="text-white mb-6">
                ...
                three-stacked battlecruiser Left elevation and deck plan of the
            ...
            <div className="timeline-item">
              ...
              <p className="text-white mb-6">
                ...
                ordered per naval programme. She differed from her predecessors
                of the Lion class in the distribution of her secondary armament
                and armour.
              </p>
            </div>
